    ...
    <div className="">
      ...
      <div className="md:hidden flex flex-col items-center justify-between h-screen px-8 text-center">
        {/* <div className="text-center px-8 my-16"> */}
          ...
          <p>Ehhez azonban az kell hogy…</p>
          <ul>
      ...
      <Image
        ...
        {/* <div className="absolute w-3/4 1/2 bg-white z-5 flex flex-col items-center p-20"> */}
          ...
          <div className=" bg-white z-5 flex flex-col items-center px-20 py-5">
          ...
          <div className=" bg-white z-5 flex flex-col items-center px-20 py-5 justify-center">
