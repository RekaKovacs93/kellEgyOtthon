    ...
    return (
        <div>
            <div className='flex items-center justify-center mt-5'>
                <button className='border-2 border-darkgrey hover:bg-black hover:bg-opacity-25 text-grey font-bold py-2 px-4 rounded-full transition duration-300 mx-10'>
            ...
            <div>
                ...
                <div className='flex flex-wrap justify-center gap-5 md:mt-10'>
                    <div style={{ backgroundColor: 'rgb(121, 116, 112)' }} className=' md:w-auto h-50 text-white rounded-lg py-10 px-10 md:mx-40 mx-10'>
