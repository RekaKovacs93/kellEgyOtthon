    ...
    return (
      <div className="flex items-center w-full justify-center min-h-screen">
        <div className="w-full sm:w-2/5 mx-4 sm:mx-20 px-8 items-center">
          <h1 className="text-3xl text-center mb-10">Szeretne idejével spórolni? Szeretne nagyobb biztonsággal vásárolni? Ha álmai otthonát keresi velünk garantáltan megtalálja!</h1>
