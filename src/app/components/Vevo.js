...
export default function Vevo() {
    return (
      <div className="flex items-center w-full justify-center md:min-h-screen">
        <div className="w-full sm:w-2/5 mx-4 sm:mx-20 px-8 items-center">
          ...
          <div className="flex items-center justify-center mt-10">
            <button className="border mb-20 md:mb-0 border-darkgrey hover:bg-black hover:bg-opacity-25 text-grey font-bold py-2 px-4 rounded-full transition duration-300">
